            ...
            <main class="flex-1 p-6 overflow-y-auto">
                ...
                <div class="max-w-6xl mx-auto">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-lg opacity-90">
                                        Generate comprehensive attendance reports with time logs and status tracking
                                    </p>
                                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-blue-500 to-cyan-600 p-6 text-white">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-blue-100">Select date range and filters for your attendance report</p>
                                </div>
                        ...
                        <!-- Form Content -->
                        <div class="p-6">
                            <form action="../controller/generate_attendance_report.php" method="get" class="space-y-6">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label for="order" class="block text-sm font-medium text-gray-700 mb-2">
                                                    <i class="fas fa-sort-amount-down text-cyan-500 mr-1"></i>
                                                    Order
                                                </label>
                                                <select name="order" 
                                                        id="order" 
                                ...
                                <div class="border-t border-gray-200 pt-6">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        ...
                                        <button type="button" onclick="setDateRange('current_year')" 
                                                class="px-4 py-2 bg-cyan-50 text-cyan-700 rounded-lg hover:bg-cyan-100 transition-colors text-sm font-medium">
                                ...
                                <div class="border-t border-gray-200 pt-6">
                                    <div class="flex justify-center">
                                        <button type="submit" 
                                                class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:from-blue-600 hover:to-cyan-700 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-200 transform hover:scale-105">
                                            <i class="fas fa-download mr-3 text-lg"></i>
                                            <span class="text-lg">Generate Attendance Report</span>
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                        <div class="feature-card bg-white rounded-xl p-6 shadow-lg">
                            ...
                            <p class="text-gray-600">
                                Comprehensive time logging with check-in/check-out times, schedules, and status tracking for all employees.
                            </p>
                        </div>
                        ...
                        <div class="feature-card bg-white rounded-xl p-6 shadow-lg">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900">Leave Integration</h3>
                            </div>
                            <p class="text-gray-600">
                                Automatically includes approved leave requests and shows attendance status for complete workforce visibility.
                            </p>
                        </div>
                        ...
                        <div class="feature-card bg-white rounded-xl p-6 shadow-lg">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900">Professional Export</h3>
                            </div>
                            <p class="text-gray-600">
                                Excel format with professional layout, company branding, and ready-to-use data for HR and management review.
                            </p>
                        </div>
                    </div>
