...
$employeeStmt = $pdo->query("
    SELECT id, fname, lname, position, official_sched 
    FROM employees 
...
<head>
    ...
    <title>Schedule Planner - Bugardi</title>
</head>
                    ...
                    <div class="card-bugardi mb-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-white mt-1">Assign work schedules to employees for the week</p>
                            </div>
                            <div class="flex items-center space-x-4">
                                <!-- Week Navigation -->
                                <div class="flex items-center space-x-2">
                                    <a href="?week=<?= date('Y-W', strtotime($startDate . ' -1 week')) ?>" 
                                       class="bg-gray-500 bg-opacity-30 backdrop-blur-sm rounded-lg px-3 py-2 text-white hover:bg-opacity-50 transition-all">
                                        <i class="fas fa-chevron-left"></i>
                                    </a>
                                    <span class="bg-gray-500 bg-opacity-30 backdrop-blur-sm rounded-lg px-4 py-2 text-white font-semibold">
