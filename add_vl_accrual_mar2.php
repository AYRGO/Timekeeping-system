...
$employeeNames = [
    ...
    ['ALVAREZ', 'JOHN BRYAN'],
    ['ANTONIO', 'VINCENT KEVIN'],
    ['ANGELES', 'CHRISTINE'],
    ['ARNIGO', 'CEDRICK'],
    ['AUSTRIA', 'LOUIS FERNAND'],
    ['BACONGALLO', 'NIKA NUEVA'],
    ['BANSIL', 'KRISTIAN DAVID'],
    ['BAUTISTA', 'OLIVE SANTOS'],
    ['BALDERAS', 'GLORY ANN'],
    ['BENALLA', 'RENNECA'],
    ['BONDOC', 'FRANCIS EUGENE'],
    ['BRIONES', 'JOHN MICHAEL'],
    ['CAMERINO', 'YRIS GAELLE'],
