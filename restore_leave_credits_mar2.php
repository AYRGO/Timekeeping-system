...
// ==============================================
$employeeData = [
    ['AGAS', 'JILLIAN', 6.50, 4, null],
    ['AGUILAR', 'IAN MYCO', 6.50, 4, null],
    ['ALIMURONG', 'JOEL', 6.00, 5, null],
    ['ALVAREZ', 'JOHN BRYAN', 6.00, 4, null],
    ['SANTOS', 'VINCENT KEVIN', 4.50, 4, null],
    ['ANGELES', 'CHRISTINE', 2.00, 5, null],
    ['ARNIGO', 'CEDRICK', 6.50, 4, null],
    ['AUSTRIA', 'LOUIS', 3.50, 5, null],
    ['BACONGALLO', 'NIKA', 0.75, 5, null],
    ['BANSIL', 'KRISTIAN', 3.00, 1, null],
    ['BAUTISTA', 'OLIV', 7.00, 5, 7],
    ['BALDERAS', 'GLORY', 3.00, 5, null],
    ['BENALLA', 'RENE', 7.50, 5, null],
    ['BONDOC', 'FRANCIS', 7.50, 5, null],
    ['BRIONES', 'JOHN MICHAEL', 3.50, 5, null],
    ['CAMERINO', 'YRIS', 5.00, 4, null],
    ['CAPATI', 'ALLEN', 2.75, 4, null],
    ['CAPIRAL', 'GABRIEL', 0.00, 0, null],
    ['CARAAN', 'SARAH', 7.00, 5, null],
    ['CASTRO', 'AIZEL', 6.50, 5, 7],
    ['CATALOGO', 'MARNIE', 3.00, 5, null],
    ['CELESTE', 'LOVELAINE', 8.00, 5, null],
    ['COLIS', 'REYMARK', 3.50, 5, null],
    ['CRISANTO', 'ELRITZ', 3.00, 5, null],
    ['DACQUIL', 'KIMBERLY', 7.50, 5, null],
    ['DAVID', 'REBECCA', 7.50, 5, null],
    ['DAVID', 'RYAN ARWIN', 6.50, 5, null],
    ['DIMLA', 'JOHSUA', 1.50, 5, null],
    ['DELA CRUZ', 'JONAS', 6.75, 5, null],
    ['DELA CRUZ', 'SHAINA', 3.25, 5, null],
    ['DOLLENTES', 'MARIA', 5.00, 5, null],
    ['ESTANIO', 'ANGELICA', 7.75, 5, null],
    ['FERNANDEZ', 'FRANCIS EMMANUEL', 5.50, 5, null],
    ['FERNANDEZ', 'MARIANNE', 2.75, 5, null],
    ['GATBONTON', 'ANALIZA', 1.50, 4, null],
    ['GATBONTON', 'BEVERLY', 1.25, 5, null],
    ['GUECO', 'JOHANA', 3.50, 5, 7],
    ['GUILLERMO', 'ALFIE', 7.50, 5, null],
    ['JABINAL', 'ADONIS', 4.75, 5, null],
    ['JOSAFAT', 'RENALYN', 3.00, 4, null],
    ['LOZANO', 'ALDWIN', 5.00, 4, null],
    ['MACAPAGAL', 'JEFFRY', 7.00, 5, null],
    ['MACLANG', 'JULIE', 6.00, 5, null],
    ['MAKABENTA', 'ALTHEA', 6.50, 2, null],
    ['MALINAO', 'ROGELIO', 3.25, 4, null],
    ['MANALILI', 'JOSHUA', 8.75, 5, null],
    ['MATAGA', 'EDITH', 7.00, 2.5, null],
    ['MAR', 'CHRISTIAN', 9.00, 4, null],
    ['MCGREGOR', 'TRISHA', 3.00, 5, null],
    ['MENDOZA', 'SEAN', 5.75, 5, null],
    ['MONIS', 'JOSHWEA', 8.75, 5, null],
    ['NAVALON', 'EVANEL', 1.50, 4, null],
    ['NU', 'IVY', 10.00, 4, null],
    ['NU', 'DOU LESTER', 7.00, 5, null],
    ['OCAMPO', 'ALFRED', 4.00, 5, null],
    ['OCAMPO', 'GODWIN', 3.00, 4, null],
    ['OTSUKA', 'SHIGERU', 5.00, 5, null],
    ['PANGAN', 'CRISTINA', 2.00, 5, null],
    ['PANGILINAN', 'ROI', 8.75, 5, null],
    ['PATAWARAN', 'SHERRY', 6.50, 5, null],
    ['YAP', 'APRYL', 3.00, 3, null],
    ['PATRIMONIO', 'R', 3.50, 3, null],
    ['PINEDA', 'ERIKA', 2.75, 4, null],
    ['PLATERO', 'MA', 7.50, 5, null],
    ['QUIZON', 'SHIRMILEY', 6.00, 5, null],
    ['RONQUILLO', 'RHEGENE', 1.00, 5, null],
    ['SAMODIO', 'JHUNEL', 7.00, 4, null],
    ['SOLAYAO', 'JANETH', 3.75, 4, null],
    ['SINGH', 'RAY', 4.50, 4, null],
    ['SORIANO', 'MARY ANN', 3.75, 5, null],
    ['TAYAO', 'ALEXANDER', 1.50, 4, null],
    ['TOLOMIA', 'RICA', 7.50, 5, null],
    ['TRINIDAD', 'JENNIFER', 3.25, 4, null],
